...
#based on the info displayed in the plots, we should remove outliers for age which is below 20 and above 80. Contact_times that exceed 10 times should also be removed from the data set rows.Unknown job positions can be removed as well

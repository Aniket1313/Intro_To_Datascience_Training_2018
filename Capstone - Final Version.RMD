...
Unfortunately, Partial Dependence Plot shows that nearly all major consumer attributes contribute to the final decision making of the random forest in a positive way. Thus it is difficult to determine what actually contributes to the results of the forrest. However, 
